...
var/global/list/vantag_choices_list = list(
		...
		*/
		...
		VANTAG_VORE		=	"Быть съеденным (любой конец)",
		VANTAG_VORE_YE	=	"Быть съеденным (софт)",
		VANTAG_VORE_YD	=	"Быть съеденным (и переваренным)",
		VANTAG_VORE_YA	=	"Быть съеденным (и впитанным)",
		VANTAG_VORE_D	=	"Съедать (любой конец)",
		VANTAG_VORE_DE	=	"Съедать (софт)",
		VANTAG_VORE_DD	=	"Съедать (и переваривать)",
		VANTAG_VORE_DA	=	"Съедать (и впитывать)",
...
var/global/list/classic_vore_sounds = list(
		...
		*/
		...
		"Введение 1" = 'sound/vore/insert.ogg',
		"Введение 2" = 'sound/vore/insertion1.ogg',
		"Введение 3" = 'sound/vore/insertion2.ogg',
		"Введение 4" = 'sound/vore/insertion3.ogg',
...
var/global/list/classic_release_sounds = list(
		...
		*/
		...
		"Шуршание одежды 5" = 'sound/effects/rustle5.ogg',
		"Застёжка" = 'sound/items/zip.ogg',
		"Выплёскивание" = 'sound/effects/splat.ogg',
		"Нет" = null
		// End of Bastion of Endeavor Translation
		)
...
var/global/list/global_vore_egg_types = list(
	...
	*/
	...
	"Курица",
	"Синтетик",
	"Синепространственная дискета",
	"Синепространственный архив",
	"Синепространственный диск",
	"Капсула",
	"Кулинарный инцидент",
	"Паучий кокон",
	"Соты",
...
var/global/list/tf_vore_egg_types = list(
	...
	*/
	"Унати"							= /obj/item/storage/vore_egg/unathi,
	"Таджар"						= /obj/item/storage/vore_egg/tajaran,
	"Акул"							= /obj/item/storage/vore_egg/shark,
	"Скрелл"						= /obj/item/storage/vore_egg/skrell,
	"Сергал"						= /obj/item/storage/vore_egg/sergal,
	"Невреан"						= /obj/item/storage/vore_egg/nevrean,
	"Человек"						= /obj/item/storage/vore_egg/human,
	"Слизень"						= /obj/item/storage/vore_egg/slime,
	"Яйцо"							= /obj/item/storage/vore_egg,
	"Ксенохимера"					= /obj/item/storage/vore_egg/scree,
	"Ксеноморф"						= /obj/item/storage/vore_egg/xenomorph,
	"Шоколадное"					= /obj/item/storage/vore_egg/chocolate,
	"Костяное"						= /obj/item/storage/vore_egg/owlpellet,
	"Глыба слизи"					= /obj/item/storage/vore_egg/slimeglob,
	"Курица"						= /obj/item/storage/vore_egg/chicken,
	"Синтетик"						= /obj/item/storage/vore_egg/synthetic,
	"Синепространственная дискета"	= /obj/item/storage/vore_egg/floppy,
	"Синепространственный архив"	= /obj/item/storage/vore_egg/file,
	"Синепространственный диск"		= /obj/item/storage/vore_egg/cd,
	"Капсула"						= /obj/item/storage/vore_egg/escapepod,
	"Кулинарный инцидент"			= /obj/item/storage/vore_egg/badrecipe,
	"Паучий кокон"					= /obj/item/storage/vore_egg/cocoon,
	"Соты" 							= /obj/item/storage/vore_egg/honeycomb,
	"Жучий кокон"					= /obj/item/storage/vore_egg/bugcocoon,
	"Камень"						= /obj/item/storage/vore_egg/rock,
	"Жёлтое"						= /obj/item/storage/vore_egg/yellow,
	"Синее"							= /obj/item/storage/vore_egg/blue,
	"Зелёное"						= /obj/item/storage/vore_egg/green,
	"Оранжевое"						= /obj/item/storage/vore_egg/orange,
	"Розовое"						= /obj/item/storage/vore_egg/purple,
	"Красное"						= /obj/item/storage/vore_egg/red,
	"Радужное"						= /obj/item/storage/vore_egg/rainbow,
	"Пятнистое розовое"				= /obj/item/storage/vore_egg/pinkspots)
	// End of Bastion of Endeavor Translation

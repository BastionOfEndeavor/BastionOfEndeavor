...
span_info("<br>\
Всего симулируемых тюрфов: [simulated_turf_count]<br>\
Всего зон: [zones.len]<br>\
Всего краёв: [edges.len]<br>\
Всего активных краёв: [active_edges.len ? "<span class='danger'>[active_edges.len]</span>" : "Нет"]<br>\

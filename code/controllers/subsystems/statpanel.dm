	...
	if (!resumed)
		...
		global_data = list(
			...
			*/
			...
			"Время раунда: [roundduration2text()]",
...
/datum/controller/subsystem/statpanels/proc/set_examine_tab(client/target)
	...
	*/
	...
	if(description_holders["info"])
		...
		*/
		examine_update += "<font color='#084B8A'>" + span_bold("[replacetext_char(description_holders["info"], "\n", "<BR>")]") + "</font><br />" //Blue, informative text.
	...
	if(description_holders["fluff"])
		...
		*/
		examine_update += "<font color='#298A08'>" + span_bold("[replacetext_char(description_holders["fluff"], "\n", "<BR>")]") + "</font><br />" //Green, fluff-related text.
		// End of Bastion of Endeavor Unicode Edit

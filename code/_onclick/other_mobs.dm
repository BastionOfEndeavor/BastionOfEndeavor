...
/mob/living/carbon/alien/UnarmedAttack(var/atom/A, var/proximity)
	...
	/* Bastion of Endeavor Translation: Bastion of Endeavor TODO: attack_generic is a huge hassle as of right now. This might need revision, but as it stands, it will be used with the verb_ru proc.
